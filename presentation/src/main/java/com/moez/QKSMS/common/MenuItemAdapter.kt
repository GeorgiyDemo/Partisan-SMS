...
class MenuItemAdapter @Inject constructor(private val context: Context, private val colors: Colors) : QkAdapter<MenuItem>() {
    ...
    override fun onBindViewHolder(holder: QkViewHolder, position: Int) {
        ...
        holder.itemView.findViewById<TextView>(R.id.title).text = menuItem.title
        holder.itemView.findViewById<ImageView>(R.id.check).isActivated = (menuItem.actionId == selectedItem)
        holder.itemView.findViewById<ImageView>(R.id.check).setVisible(selectedItem != null)
    }
