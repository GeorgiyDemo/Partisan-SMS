...
import org.lapka.sms.injection.AppComponentManager
...
import org.lapka.sms.migration.QkMigration
import org.lapka.sms.migration.QkRealmMigration
...
class QKApplication : Application(), HasAndroidInjector {
    ...
    override fun onCreate() {
        ...
        Realm.init(this)
        val realmKey = org.lapka.sms.common.util.RealmKeyProvider.getOrCreateRealmKey(this)
