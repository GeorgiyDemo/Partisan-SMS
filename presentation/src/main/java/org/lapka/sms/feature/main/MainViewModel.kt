...
import org.lapka.sms.common.base.QkViewModel
import org.lapka.sms.extensions.mapNotNull
import org.lapka.sms.interactor.DeleteConversations
import org.lapka.sms.interactor.MarkAllSeen
import org.lapka.sms.interactor.MarkArchived
import org.lapka.sms.interactor.MarkPinned
import org.lapka.sms.interactor.MarkRead
import org.lapka.sms.interactor.MarkUnarchived
import org.lapka.sms.interactor.MarkUnpinned
import org.lapka.sms.interactor.MarkUnread
import org.lapka.sms.interactor.MigratePreferences
import org.lapka.sms.interactor.SyncContacts
import org.lapka.sms.interactor.SyncMessages
        ...
        view.conversationsSelectedIntent
            .withLatestFrom(state) { selection, state ->
                ...
                when (state.page) {
                    is Inbox -> {
                        val page =
                            state.page.copy(addContact = add, markPinned = pin, markRead = read, selected = selected)
