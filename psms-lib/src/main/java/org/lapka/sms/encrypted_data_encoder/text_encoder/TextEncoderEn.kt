...
class TextEncoderEn(
    ...
    private constructor() : this(
        ...
        listOf(DateTimeSubEncoder()) +
                WordsSubEncoderInstancesEn.instances +
                WordsSubEncoderInstancesEn9.instances +
                WordsSubEncoderInstancesEn10.instances
    )
    ...
    companion object {
        ...
        @JvmStatic
        fun getInstance(): TextEncoderEn = instanceHolder

        private val instanceHolder: TextEncoderEn by lazy { TextEncoderEn() }
    }
    ...
    override fun decode(str: String): ByteArray {
        ...
        while (index < str.length) {
            ...
            if (decodeResult == null) {
                throw InvalidDataException("'$str' at $index is not in valid Text English scheme")
            }
        }
